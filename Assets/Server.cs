...
#if UNITY_EDITOR
    List<Card.Cardname> TESTCARDS = new List<Card.Cardname>() {Card.Cardname.Hunters_Mark, Card.Cardname.Ironbeak_Owl,Card.Cardname.Millhouse_Manastorm,Card.Cardname.Loatheb};

...
#if UNITY_EDITOR
    List<Card.Cardname> TESTCARDS = new List<Card.Cardname>() { Card.Cardname.Backstab,Card.Cardname.Backstab,Card.Cardname.Backstab,Card.Cardname.Backstab,Card.Cardname.Backstab, Card.Cardname.Slam, Card.Cardname.Execute, };

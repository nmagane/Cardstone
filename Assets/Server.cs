...
#if UNITY_EDITOR
    List<Card.Cardname> TESTCARDS = new List<Card.Cardname>() {Card.Cardname.SI7_Agent, Card.Cardname.Deadly_Poison, Card.Cardname.Eviscerate, Card.Cardname.Archmage_Antonidas, Card.Cardname.Emperor_Thaurissan };

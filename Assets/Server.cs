...
#if UNITY_EDITOR
    List<Card.Cardname> TESTCARDS = new List<Card.Cardname>() { Card.Cardname.SI7_Agent, Card.Cardname.Backstab, Card.Cardname.Backstab, Card.Cardname.Backstab, Card.Cardname.Eviscerate };
